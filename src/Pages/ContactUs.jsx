...
const ContactUs = () => {
    return (
        <div className="max-w-[1440px] w-[95%] mx-auto sm:mt-10 mt-6 mb-20">
            <div className="rounded-2xl lg:w-[700px] mx-auto shadow-2xl py-10 px-6 "> 
                ...
                <form className="grid sm:grid-cols-2 grid-cols-1 gap-5 border-t-2 border-dashed border-pmColor pt-8">
                    ...
                    <button className="group sm:col-span-2 relative w-full inline-flex bg-pmColor h-12 items-center justify-center overflow-hidden rounded-md px-6 font-medium text-neutral-200">
                        <span>Sent</span>
