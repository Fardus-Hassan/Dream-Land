...
const LoginPage = () => {
    ...
    return (
        <div className="flex flex-col justify-center items-center sm:mt-20 mt-10 mb-20 rounded-2xl py-10 sm:px-6 shadow-2xl sm:w-[400px] w-[95%] mx-auto">
            ...
            <div className="flex items-center justify-center mb-5 mt-4 gap-3 w-[95%]">
            ...
            <p className="text-sm text-center text-black font-inter font-medium">Do not have any account?  please <Link to='/register' className="text-pmColor font-semibold" >Register</Link> 👈</p>
        </div>
    );
};
